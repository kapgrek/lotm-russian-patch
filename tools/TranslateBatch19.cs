...
class TranslateBatch19
{
    ...
    static string CachePath = @"d:\gameDev\translate lotm\tools\batch19_cache.tsv";
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine(string.Format("=== Запуск перевода Пакета №19 (Лимит: {0} уникальных строк) ===", maxTarget));
        ...
        // 3. Сбор кандидатов для Пакета №19
        ...
        Console.WriteLine(string.Format("Отобрано для Пакета №19: {0} уникальных строк", candidates.Count));
        ...
        Console.WriteLine(string.Format("Пакет №19 успешно завершен! Новый размер словаря: {0} записей.", existingRu.Count));
    }
