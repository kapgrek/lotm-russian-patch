...
class AnalyzeBatch5
{
    ...
    static void Main()
    {
        ...
        var noTagUntranslated = new List<Tuple<string, string>>();
            ...
            while ((line = reader.ReadLine()) != null)
            {
                ...
                if (t.StartsWith("[\"") && (t.EndsWith("\",") || t.EndsWith("\"")))
                {
                    ...
                    if (delim > 0)
                    {
                        ...
                        {
                            if (noTagUntranslated.Count < 20)
                            {
                                noTagUntranslated.Add(Tuple.Create(cnKey, enVal));
                            }
                        }
                    }
                }
        ...
        Console.WriteLine("\nSamples of no-tag untranslated:");
        foreach (var sample in noTagUntranslated)
        {
            Console.WriteLine(string.Format("  CN: {0} | EN: {1}", sample.Item1, sample.Item2));
        }
    }
}
