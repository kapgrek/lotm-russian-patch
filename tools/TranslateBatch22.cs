...
class TranslateBatch22
{
    ...
    static string CachePath = @"d:\gameDev\translate lotm\tools\batch22_cache.tsv";
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine(string.Format("=== Запуск перевода Пакета №22 (Лимит: {0} уникальных строк) ===", maxTarget));
        ...
        // 3. Сбор кандидатов для Пакета №22
        ...
        Console.WriteLine(string.Format("Отобрано для Пакета №22: {0} уникальных строк (из {1} кандидатов)", candidates.Count, scoredList.Count));
        ...
        Console.WriteLine(string.Format("Пакет №22 успешно завершен! Новый размер словаря: {0} записей.", existingRu.Count));
    }
