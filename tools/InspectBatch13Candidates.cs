...
class InspectBatch13Candidates
{
    ...
    static void Main()
    {
                ...
                if (t.StartsWith("[\"") && (t.EndsWith("\",") || t.EndsWith("\"")))
                {
                    ...
                    if (delim > 0)
                    {
                        ...
                        if (lsiTagMap.TryGetValue(sk, out tags))
                        {
                            ...
                            else if (tags.Contains("itemnormal") || tags.Contains("item")) itemNormal.Add(Tuple.Create(cnKey, enVal));
        ...
        Console.WriteLine("\n=== Tagged Candidate Breakdown for Batch 13 ===");
        ...
        Console.WriteLine("  itemnormal / item: " + itemNormal.Count);
