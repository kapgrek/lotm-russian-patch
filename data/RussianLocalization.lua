...
-- Сокращенные названия для узких слотов и плашек экипировки (предотвращают троеточие "...")
Russian.shortEquipLabels = {
    ...
    ["Badge"] = "Значок",
    ["Accessory"] = "Аксессуар",
    ["Sealed Artifact"] = "Артефакт",
    ["Special Skill (No Equipment Required)"] = "Особые навыки",
    ["Equipment Reform"] = "Перековка",
    ["Equipment Enhancement"] = "Усиление",
    ["Equip Strengthen"] = "Усиление",
    ["Equipment Strengthen"] = "Усиление",
    ["Affix Inheritance"] = "Наследие",
    ["Quick Equip"] = "Надеть",
    ["One-Click Upgrade"] = "Прокачать",
    ["One-Click Equip"] = "Надеть всё",
    ["Recommended Build"] = "Рек. сборка",
    ["Current Build"] = "Тек. сборка",
    ["Equipped"] = "Надето",
    ["In Use"] = "Используется",
    ...
    -- Русские длинные фразы -> компактные замены для узких слотов
    ["Сборки экипировки"] = "Сборка",
    ["Сборка экипировки"] = "Сборка",
    ["Особые навыки (без экипировки)"] = "Особые навыки",
    ["Запечатанный артефакт"] = "Артефакт",
    ["Слияние духовности"] = "Конвергенция",
    ["Наследование свойств"] = "Наследие",
    ["Рекомендованная сборка"] = "Рек. сборка",
    ["Текущая сборка"] = "Тек. сборка",
    ["Основное оружие"] = "Оружие",
    ["Второстепенное оружие"] = "Втор. рука",
}
...
Russian.visibleTextExactOverrides = {
    ...
    ["Войти в необыкновенный мир"] = "Войти",
